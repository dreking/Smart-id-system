 ...
 * @author Dre
 */
public class ViewMoneyStudent extends javax.swing.JFrame {
    String ch1=null;
    Connection con=null;
    ResultSet rs1=null;
    ResultSet rs2=null;
        ...
        try{
            if(ch1=="usn"){
                ...
                String sql1="SELECT * FROM student as S,credited as C WHERE S.usn=C.reg_no "
                            + "AND usn='"+a+"'";
                String sql2="SELECT * FROM student as S,debited as D WHERE S.usn=D.reg_no "
                            + "AND usn='"+a+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewMoneyStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewMoneyStudent().setVisible(true);
            }
        });
    }
