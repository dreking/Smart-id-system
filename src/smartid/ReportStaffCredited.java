 ...
 * @author Dre
 */
public class ReportStaffCredited extends javax.swing.JFrame {
    DefaultTableModel model=null;
    Connection con=null;
    ResultSet rs=null;
    /**
     * Creates new form ReportStaffCredited
     */
    public ReportStaffCredited() {
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        SearchStaffCredited s=new SearchStaffCredited();
        s.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportStaffCredited.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportStaffCredited().setVisible(true);
            }
        });
    }
