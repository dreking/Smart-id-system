...
public class SearchTransaction extends javax.swing.JFrame {
    ...
    String id="search";
    /**
     * Creates new form SearchTransaction
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ReportTransaction r=new ReportTransaction();
        a=usn.getText();
        try{
            if(ch1=="usn"){
                if(ch2=="date"){
                    ...
                    String sql="SELECT * FROM student as S,debited as D WHERE S.usn=D.reg_no "
                            + "AND usn='"+a+"' AND date BETWEEN '"+dfrom+"' AND '"+dto+"'";
                    ...
                    Connection c1=db.java_db();
                    Statement st=c1.createStatement();
                    String sql1="SELECT * FROM student as S,debited as D WHERE S.usn=D.reg_no "
                            + "AND usn='"+a+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchTransaction.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
