...
public class AddStaffMoney extends javax.swing.JFrame {
    Connection con=null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddStaffMoney.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddStaffMoney().setVisible(true);
            }
        });
    }
