 ...
 * @author Dre
 */
public class SearchCredited extends javax.swing.JFrame {
    String a=null,ch1=null,ch2=null;
    ResultSet rs=null;
    ResultSet rs1=null;
    Connection con=null;
    /**
     * Creates new form SearchCredited
     */
    public SearchCredited() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchCredited.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchCredited().setVisible(true);
            }
        });
    }
