...
public class SearchAttendance extends javax.swing.JFrame {
    ...
    String curDate=null,curTime=null,lastDate=null;
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(usn, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ReportAttendance r=new ReportAttendance();
        String a=usn.getText();
        try{
            Connection c1=db.java_db();
            Statement st=c1.createStatement();
            String sql="SELECT * FROM student AS S, attendance as A WHERE S.usn=A.reg_no"
                        + " AND (usn='"+a+"' OR rfid='"+a+"' ) AND date between '"+lastDate+"' AND '"+curDate+"' ";
