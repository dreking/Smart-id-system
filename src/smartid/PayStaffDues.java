...
import static smartid.AddStudentMoney.curDate;
import static smartid.AddStudentMoney.curTime;

public class PayStaffDues extends javax.swing.JFrame {
    ...
    int d1;
    String em=null;
    Double deb=0.0,cred=0.0,total=0.0;
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Use Registration Number");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(ch=="usn")
        {
            try{
                ...
                String sql="SELECT * FROM staff AS S,account AS A WHERE S.reg_no=A.reg_no AND S.reg_no='"+a+"'";
            ...
            try{
                ...
                String s1="SELECT * FROM staff AS S,account AS A WHERE S.reg_no=A.reg_no AND S.rfid='"+a+"'";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(total<spent)
            JOptionPane.showMessageDialog(null, "Please add more money");
        else{
            try{
                Connection c1=db.java_db();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PayStaffDues.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PayStaffDues().setVisible(true);
            }
        });
    }
