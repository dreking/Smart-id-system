 ...
 * @author Dre
 */
public class SearchStaffDebited extends javax.swing.JFrame {
    ...
    String id="search";
    /**
     * Creates new form SearchStaffDebited
     */
    public SearchStaffDebited() {
        initComponents();
        ...
        try{
            if(ch1=="usn"){
                if(ch2=="date"){
                    ...
                    Connection c1=db.java_db();
                    Statement st=c1.createStatement();
                    String sql1="SELECT * FROM staff as S,debited as D WHERE S.reg_no=D.reg_no "
                    + "AND S.reg_no='"+a+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchStaffDebited.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchStaffDebited().setVisible(true);
            }
        });
    }
